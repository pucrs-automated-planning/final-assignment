(define (problem pb2)
	...
	(:init 
		...
		(connected h11 sw13) (connected sw13 h11)



		(connected fw sw12) (connectedvirt sw12 fw)
		(connected proxy sw22) (connectedvirt sw22 proxy)
		(connected nat sw32) (connectedvirt sw32 nat)
		(connected ips sw42) (connectedvirt sw42 ips)

		(connected proxy sw13) (connected sw13 proxy)
		(connected fw sw23) (connected sw23 fw)
		(connected ips sw33) (connected sw33 ips)
		(connected nat sw43) (connected sw43 nat)
